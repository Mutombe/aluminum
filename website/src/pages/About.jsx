  ...
  return (
    <>
      ...
      <section ref={containerRef} className="relative py-24 md:py-32 bg-arch-platinum overflow-hidden">
        ...
        >
          <BeamConnectionPattern className="w-full h-full text-arch-silver" opacity={1} />
        </motion.div>
        ...
        <div className="relative w-full max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 xl:px-20">
            ...
            <AnimatedSection delay={0.2}>
              <div className="relative p-8 rounded-2xl bg-white border border-arch-silver-light h-full overflow-hidden group hover:border-arch-gold/50 transition-colors duration-500 shadow-soft">
                ...
                <div className="absolute top-0 right-0 w-32 h-32 opacity-[0.03]">
                  <HexagonalGrid className="w-full h-full text-arch-silver" opacity={1} />
                </div>
              </div>
            </AnimatedSection>
          </div>
          ...
          <AnimatedSection className="mb-24">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Heart, title: 'Quality', desc: 'Uncompromising standards in every product we create', pattern: 'beam' },
                { icon: Lightbulb, title: 'Innovation', desc: 'Embracing new technologies and design approaches', pattern: 'circuit' },
                { icon: BiShieldQuarter, title: 'Integrity', desc: 'Honest dealings and transparent relationships', pattern: 'angular' },
                ...
                <AnimatedSection key={value.title} delay={index * 0.1}>
                  <div className="relative text-center p-6 rounded-xl bg-white border border-arch-silver-light hover:border-arch-gold/50 transition-all duration-300 group overflow-hidden shadow-soft">
                    ...
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-10 transition-opacity duration-500">
                      ...
                      {value.pattern === 'circuit' && <CircuitPattern className="w-full h-full" />}
          ...
          <AnimatedSection>
            <div className="relative p-8 md:p-12 rounded-3xl overflow-hidden">
              ...
              <div className="absolute right-0 top-0 bottom-0 w-1/3 opacity-[0.05]">
                <CurtainWallPattern className="w-full h-full text-arch-gold" rows={6} cols={4} />
              </div>
              ...
              <div className="relative grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                {[
                  ...
                  >
                    ...
                    <p className="text-arch-silver-light text-sm md:text-base">{stat.label}</p>
                  </motion.div>
                ))}
              </div>
            </div>
      ...
      <section className="relative py-24 md:py-32 bg-arch-platinum overflow-hidden">
        ...
        <div className="relative w-full max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 xl:px-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: LiaAwardSolid, title: 'CIFOZ Member', desc: 'Proud member of the Construction Industry Federation of Zimbabwe, upholding the highest industry standards.', pattern: 'hex' },
              { icon: SiFsecure, title: 'Fully Insured', desc: 'Third Party Insurance and Advance Payment Guarantee provided by reputable financial institutions.', pattern: 'circuit' },
